...
function Function_switch_team() {
	 ...
	 var y = document.getElementById("switchteam").checked;
...
function clear_numbers_in_local_storage(){
	 localStorage.clear();
	 Function_save_players();
	}
...
function change_highlighted_buttons_color(){
	 ...
	 document.getElementById("switchbatLabde").style.backgroundColor = main_3_input_button_color;
	}
